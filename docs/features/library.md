...
Pipkin's concrete generic modules include an OS-backed file lease and a serialized Git `info/exclude` updater used by features that coordinate checkout-local state.
