...
| [pi-implement](packages/pi-implement)         | Run `/implement` on a markdown plan checklist with isolated cumulative candidates, typed review findings, and retained stalled-run recovery. |
